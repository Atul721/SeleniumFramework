...
public class standAlone {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("atul721@gmail.com");
...
//		a.moveToElement(driver.findElement(By.cssSelector(".action__submit"))).click().build().perform();
		...
		WebElement pay = driver.findElement(By.cssSelector(".action__submit"));
//		a.moveToElement(pay).click().build().perform();
		pay.click();
